export default {
  ...
  footer: (<div className="my-24  border-t-2  mx-auto flex items-center sm:flex-row flex-col">
      <p className="text-sm text-gray-500">© By John Doe  —
        <a href="https://twitter.com/John Doe" className="text-gray-600" rel="noopener noreferrer" target="_blank">@John Doe</a>
      </p>
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        ...
        <a target="_blank" href="https://twitter.com/John Doe" className="ml-3 text-gray-500">
          <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
